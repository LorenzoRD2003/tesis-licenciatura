...
Esta sección describe el flujo operacional completo que une las partes presentadas en las secciones anteriores en un protocolo transaccional ejecutable. En particular, explica cómo se ensamblan las transacciones, qué ajustes de tooling fueron necesarios para volver reproducible el flujo y cómo se organizó la validación mediante tests.
