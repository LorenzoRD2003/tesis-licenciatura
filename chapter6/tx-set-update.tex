...
La utilidad del circuito en el protocolo aparece al mirar \TxsUpdaterMintingValidator. Sus condiciones de aceptación fueron formalizadas en las secciones iniciales de este capítulo y forman parte de las condiciones necesarias de \MintTx. El mapeo entre la matemática del argumento \Groth y la validación \Onchain es el siguiente:
