...
En la fase recurrente de actualización, \StakeDistTx consume el \UTxO que contiene el certificado padre y produce un nuevo \UTxO con el mismo NFT y con el certificado nuevo en el datum. Este bloque inicial ya fija varios invariantes útiles: el nuevo certificado debe ser del tipo correcto, debe estar correctamente encadenado con su padre y el control del estado debe permanecer en el mismo script. La interpretación detallada de qué significa, en términos de \Mithril, que un certificado sea correcto se apoya en el capítulo dedicado a \Mithril; las secciones de circuitos de este capítulo completan cómo esa evidencia se consume luego mediante argumentos de inclusión y recibos de verificación.
