...
\begin{enumerate}[noitemsep]
  ...
  \item A partir de \redeemer y del valor \textit{minteado} por la transacción, puede reconstruirse y verificarse una versión esperada de \LockTx (esto cambia en la segunda etapa de implementación).
