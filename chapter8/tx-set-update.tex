...
La utilidad del circuito en el protocolo aparece al mirar la interfaz del \TxsUpdaterMintingValidator, cuyas condiciones de aceptación fueron formalizadas en el Capítulo 6 y forma parte de las condiciones necesarias de \MintTx. El mapeo entre la matemática del argumento \Groth y la validación \Onchain es el siguiente:
