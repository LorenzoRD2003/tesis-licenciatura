...
%TODO: mejorar la explicacion en esta seccion
...
La utilidad del circuito en el protocolo aparece al mirar la interfaz del \MintingValidator, cuyas condiciones de aceptación fueron formalizadas en el Capítulo 6 y forman parte de las condiciones necesarias de \MintTx. El mapeo entre la matemática del argumento \Groth y la validación \Onchain es el siguiente:
\begin{enumerate}[noitemsep]
