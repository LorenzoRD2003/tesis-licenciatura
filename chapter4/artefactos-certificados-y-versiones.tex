...
\begin{figure}[!t]
  ...
  \end{tikzpicture}
  \caption{Estructura de una prueba de pertenencia en \CardanoTransactions \textit{legacy}. La \RangeProof certifica que una transacción concreta pertenece al Merkle Tree de un rango de bloques $R_u$; la \MasterProof certifica que la hoja maestra \(\TxRangeLeaf{u}\), formada por \(\RangeKey(R_u)\) y \(\TxRangeRoot{u}\), pertenece al Merkle Tree maestro cuya raíz firmada es \(\TxSetRoot\).}
