...
El README del circuito aclara, sin embargo, que este camino todavía no está conectado al operador ni es compatible con \texttt{tx prove}, precisamente porque el formato del \textit{witness} todavía no coincide con la forma de prueba que entrega el \MithrilAggregator actual. Por eso, en el capítulo siguiente aparecerán dos circuitos: uno plenamente alineado con el camino \Pythagoras hoy soportado por el servicio, y otro de carácter experimental que adelanta cómo debería verse la ruta \Lagrange cuando esa interfaz deje de ser sólo inferible desde el código y pase a estar efectivamente desplegada.
