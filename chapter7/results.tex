...
Este capítulo resume el resultado principal de la implementación final: el flujo transaccional del \zkBridge efectivamente entra dentro de los límites de recursos de \Cardano discutidos en el capítulo \emph{Cardano y Modelo \eUTxO}, en particular \maxTxSize y \maxTxExUnits. Para evaluarlo, tomamos las transacciones concretas del flujo final y comparamos su tamaño serializado, su consumo de CPU y su consumo de memoria contra los parámetros de protocolo introducidos en la Tabla~\ref{tab:cardano-protocol-limits}.
