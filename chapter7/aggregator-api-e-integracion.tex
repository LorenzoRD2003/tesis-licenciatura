...
Finalmente, si los chequeos fueron exitosos, el \ZkBridgeOperator exporta \textit{inputs} válidos para los circuitos \texttt{snapshot\_membership} y \texttt{tx\_set\_update}, a desarrollar en el Capítulo 8.
