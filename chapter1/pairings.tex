...
Diversas implementaciones criptográficas modernas utilizan curvas emparejables específicas. Entre las más relevantes se encuentran:
\begin{itemize}[itemsep=0.1 cm]
	\item \BN (\texttt{bn128}): utilizada históricamente en \Ethereum.
	\item \BLS: ampliamente adoptada en sistemas criptográficos modernos.
\end{itemize}
