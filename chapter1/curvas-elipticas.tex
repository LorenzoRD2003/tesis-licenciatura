...
\begin{figure}[ht]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Curva elíptica sobre $\R$ asociada a la ecuación $\E: y^2 = x^3 - x + 1$.}
...
\begin{figure}[ht]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Puntos racionales de la curva elíptica $\E(\F_{19})$ asociada a la ecuación $y^2 = x^3 - x + 1$, con $P=(2,8)$, $Q=(3,5)$ y el resultado de la suma algebraica $P+Q=(4,17)$ destacados.}
