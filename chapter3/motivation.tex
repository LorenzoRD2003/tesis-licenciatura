...
\begin{enumerate}[noitemsep]
		\item Un sistema de pruebas más amigable para verificadores auxiliares acotados. En esta tesis, \Groth se usa en relaciones de bajo costo de verificación, como pertenencia a snapshots y actualización del \SMT anti-replay, debido a su verificación eficiente y tamaño de prueba constante.
		\item Reducir el trabajo \Onchain usando proof recursion o proof aggregation.
		\item Dividir la verificación en múltiples transacciones cuando el objeto criptográfico completo no entra en presupuesto. Este es el caso de los certificados \Mithril, cuya verificación \STM sigue el camino \HaloTwo/\Midnight y requiere partición en dos fases.
\end{enumerate}
