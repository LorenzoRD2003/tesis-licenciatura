...
\label{def:apendice-b-arithmetic-circuits-circuito-aritmetico}
...
\label{subsec:apendice-b-arithmetic-circuits-construccion-de-un-ejemplo}
...
Esta reformulación puramente algebraica del cómputo es precisamente la perspectiva adoptada por los sistemas de prueba modernos. En la Sección~\ref{sec:aritmetizacion-y-construccion-de-un-snark-sistemas-de-restricciones-ronecs-rank-1-constraint-systems} introduciremos Rank-1 Constraint Systems (\ROneCS), que son una representación canónica y particularmente conveniente de circuitos aritméticos para llegar a los \SNARK. En este caso, un \SNARK va a permitir demostrar, mediante un argumento sucinto (asintóticamente menos que la cantidad de compuertas) y no interactivo, que existe una asignación de valores que satisface todas las igualdades inducidas por el circuito $\Circuit$, sin revelar dicha asignación.

\subsection{Lo que tenemos hasta ahora}
\label{subsec:apendice-b-arithmetic-circuits-lo-que-tenemos-hasta-ahora}
...
\label{subsec:apendice-b-arithmetic-circuits-limitaciones-de-los-circuitos-aritmeticos}
