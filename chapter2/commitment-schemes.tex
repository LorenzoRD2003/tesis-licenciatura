...
Ahora, vamos a conectar estas ideas con las primitivas criptográficas ya introducidas. Desde una perspectiva puramente algebraica, $P(z) = y$ equivale a que el polinomio $Q(x) = P(x) - y$ tiene a $z$ como raíz, es decir que existe un polinomio $H \in \poly{\K}$ tal que $P(x) - y = (x - z)H(x)$. El problema se reduce entonces a argumentar esta afirmación.
