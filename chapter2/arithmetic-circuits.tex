...
\begin{figure}[ht]
	...
	\end{tikzpicture}
		\caption{Circuito aritmético $\Circuit$ para la relación $y = (w_1 + x_1) \cdot (w_2 + x_2 + 1) + w_3 \cdot x_3$}
...
Al final, se realiza un chequeo de la salida, es decir se verifica $y' = y$. Esto no es una puerta booleana adicional dentro del circuito, sino una condición externa de aceptación que expresa la correctitud del cómputo respecto de la salida pública declarada. Aquí $y'$ es la evaluación del circuito, mientras que $y$ es el \textit{input} público esperado.
