...
\begin{enumerate}[noitemsep]
	...
	\item \textbf{Binding entre verificación y consumo.} Todo \ProofReceipt consumido por una actualización o por \MintTx fue producido por la fase final del verificador correspondiente y fija el \texttt{statement\_hash} que debe coincidir con el mensaje del certificado presentado. Los recibos independientes y los chequeos sobre el tipo y los campos del certificado separan los distintos dominios del flujo.
