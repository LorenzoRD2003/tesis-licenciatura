...
La garantía adoptada es acotada: el bridge autentica las entidades certificadas que consume y hereda para ellas los supuestos de seguridad y vigencia de \Mithril. Del mismo modo, el prototipo valida una formulación compatible de $\LockTx$ y $\MintTx$, pero no pretende cubrir sin adaptaciones pares arbitrarios de cadenas heterogéneas. Estas limitaciones se retoman al evaluar el alcance alcanzado en la Subsección~\ref{subsec:conclusions-and-future-work-modelo-de-seguridad-y-alcance-del-prototipo}.
